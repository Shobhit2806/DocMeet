    ...
    <div className="formSignupPar">
      <Form className="formSignup" onSubmit={handleSubmit}>
        ...
        <FormGroup row>
          ...
          <Input
            onChange={(e) => sethelpline1(e.target.value)}
            type="text"
            name="helpline1"
            id="exampleHelpline1"
            placeholder="Helpline1"
          />
        </FormGroup>
        <FormGroup row>
          <Label for="exampleHelpline2">Helpline2</Label>
          <Input
            onChange={(e) => sethelpline2(e.target.value)}
            type="text"
            name="helpline2"
            id="exampleHelpline2"
            placeholder="Helpline2"
          />
        </FormGroup>
        <FormGroup row>
